...
#
#  $ bin/test -s cjf.poc -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src cjf.poc.testing.CJF_POC_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/cjf/poc/tests/robot/test_example.robot
#
